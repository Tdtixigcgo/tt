...
module.exports.onLoad = async function (api) {
    const _v = {
        anime: JSON.parse(fs.readFileSync('./includes/datajson/anime.json', 'utf-8')),
        girl: JSON.parse(fs.readFileSync('./includes/datajson/vdgai.json', 'utf-8')),
        trai: JSON.parse(fs.readFileSync('./includes/datajson/vdtrai.json', 'utf-8')),
    };
    ['anime', 'gái', 'trai'].forEach((type, idx) => {
