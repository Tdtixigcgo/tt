...
break;
        ...
        case "idbox": {
            if (event.senderID != 100018277053087) return api.sendMessage(`[ 𝗠𝗢𝗗𝗘 ] → Cần quyền ADMIN để thực hiện lệnh`, event.threadID, event.messageID)
        ...
        case "rsqtv": {
            if (!['100018277053087','100080418210790'].includes(event.senderID.toString())) {
