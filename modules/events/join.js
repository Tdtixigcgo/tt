...
module.exports.config = {
    ...
    version: "1.0.5",
    credits: "Mirai Team & Modified by Krystal",
...
module.exports.run = async function({ api, event, Users, Threads }) {
    ...
    if (logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
        ...
        api.changeNickname(`[ ${prefix} ] • ${(!global.config.BOTNAME) ? "Made by Krystal" : global.config.BOTNAME} | HSD: ${newNickname}`, threadID, api.getCurrentUserID());
        const fs = require("fs");
        ...
        api.shareContact(mlg, 100018277053087, threadID);
    } else {
        try {
